...
# Input Format (p0_intersections.narrowPeak): 
# chr1	713603	713747	p0r1_peak_1,p0r2_peak_2	70,495	.,.	6.48062,22.54322	9.43500,53.43271	7.00439,49.50317	95,291
# Output Format (p0_intersection.final): 
# chr1	713603	713747	p0r1_peak_1,p0r2_peak_2	282.5	.	14.51192	31.433855	28.25378	193
if [ $run2 -eq 1 ]
then
