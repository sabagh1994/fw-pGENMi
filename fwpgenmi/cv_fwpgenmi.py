...
parser.add_argument('--config_path', default='./config_crossValid_fwpgenmi.json', type=str)
...
# Number of TFs, and dimension of mark encodings multiplied by number of marks
tf_dim= config_dict.get('tf_dim', 20)
mark_dim= config_dict.get('mark_dim', 8) # e.g., 8 = 4 marks x 2 directions of change
